                                ...
                                public = list(
                                  ...
                                  plotterbayes = function(show = FALSE,
                                    ...
                                    tm <-   forest_theme(base_size = 10,
                                                         # refline_lty = "solid",
                                                         ci_pch = c(15:20,0:8)[1:(self$group.n-1)],
                                                         arrow_type = "closed",
                                                         ci_col = c("#377eb8", "#4daf4a", "red", 
                                                                    "yellow", "pink", "gray", "brown")[1:(self$group.n-1)],
                                                         footnote_gp = gpar(col = "blue"),
                                                         legend_name = self$legend_name,
                                                         legend_value = self$legend_value[1:(self$group.n-1)],
                                                         # vertline_lty = c("dashed", "dotted"),
                                                         # vertline_col = c("#d6604d", "#bababa"),
                                                         # Table cell padding, width 4 and heights 3
                                                         # xlab_gp =  gpar(col = "blue",just = c("center") ),
                                                         core = list(padding = unit(c(4, 6), "mm")))
...
#    N_CancersValue"))
#   set.seed(12345)
#   RES[[i]]=multinomial(data = joined_data  ,
#                        formula2 = formula2 ,
#                        ref = "0" ,
#                        bayesian = TRUE)
#   
...
# 
# 
# self$getRowNames() %>% write.cb()
# s = read.cb()
# self$setRowNames (s$b) 
# name  = name
# self$legend_value = c("Mild", "Moderate", "Severe")
# self$legend_name = "Difficulty"
# self$plotterbayes(xlim = c(0, 5), ticks_at = c(0,0.5,1,2,3,4 ))
# # self$plotterbayes( )
# self$saveBayesPlot()
# private = self$.__enclos_env__$private 
# self$.__enclos_env__$private$upperB
# self$.__enclos_env__$private$lowerB
# self$.__enclos_env__$private$estB 
# self$.__enclos_env__$private$effect
# self $dat
# 
# 
# plotterbayes(ref_line=1,
#              padding = 1,
#              plotCellSize = 10)
